...
Summarizer:
[] update prompt to optimize summaries (use Open Deep research?)
[] add tagging feature --> extract tags from annotated outline and apply them to documents as they are summarized
...
[] version where instead of answer question, it uses the above method to return most relevant sources

Zotero Collections:
[] collection processing --> make sure all attachments have parent nodes;